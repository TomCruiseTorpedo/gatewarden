...
export declare const COMPAT_SCHEMA_VERSION = "1.0.0";
/** Bump this when the evals.jsonl entry shape changes in a breaking way. */
export declare const EVALS_SCHEMA_VERSION = "1.0.0";
 ...
 * (arXiv 2605.09730).
 */
export type AxisName = 'namespacing' | 'tool-selection-confusion' | 'param-strictness' | 'output-leanness' | 'error-helpfulness';
/** Every axis in a fixed order for iteration. */
export declare const AXIS_NAMES: readonly AxisName[];
/**
 ...
 */
export declare const DETERMINISTIC_AXES: ReadonlySet<AxisName>;
/**
 ...
 */
export type LineageCategory = 'tool-choice' | 'call-signature' | 'output-contract' | 'provider-only';
