...
export type Capability = FsReadCapability | FsWriteCapability | HttpCallCapability | SpendCapability;
/**
...
export type AuditEventType = 'request' | 'decision' | 'issuance' | 'use' | 'denial' | 'revocation';
