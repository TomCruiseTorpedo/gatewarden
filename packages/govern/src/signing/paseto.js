...
hashes.sha512 =
    (msg) => createHash('sha512').update(msg).digest();
 ...
 */
export function v4PublicSign(message, secretKey, footer = new Uint8Array(), implicitAssertion = new Uint8Array()) {
 ...
 */
export function v4PublicVerify(token, publicKey, implicitAssertion = new Uint8Array()) {
    // 1. Header check
